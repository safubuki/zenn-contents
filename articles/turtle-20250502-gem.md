...
まずは、このGemを使うと何が変わるのか、以下の比較をご覧ください。同じ質問をしても、Gemを使うことでより新しい情報に基づいた回答が得られていることがわかります。
...
以下の動画で使用している映像用のプロンプト、実は音楽の歌詞に合わせて、このGemを使い一括で生成したものなのです。
...
![](/images/turtle-20250502-gem/gem_output.png =400x)
*Gem AIからのアウトプットイメージ*
...
以下の文章をGemのカスタム指示欄に貼り付けてご使用下さい。
※このGemは、まだ使用実績がそれほど無いため期待する動作をしない可能性があります。その場合は、適宜AIに相談しながら改善してみてください。
```
