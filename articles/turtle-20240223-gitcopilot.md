...
GitHub Copilotは、自然言語による指示やコードの一部を入力するだけで、目的のコードを生成してくれます。さらに、問題点の検出と修正、コメントやテストの作成など、あらゆることをこなしてくれます。そして、それがエディタ上ですぐに反映できるので、開発がとてもスムーズです。
...
このブログでは、GitHub Copilotが初めてという方のために**使い方の基本**を実例と図を交えながら丁寧に説明します。また、すでに使っている人にも満足いただけるよう**品質を高めるコツ**を紹介します。このブログを読んで、あなたもぜひGitHub Copilotの魅力を感じてみてください👍
...
- 実際にGitHub Copilot使ってみたものの、どのように生かしたら良いか困っている方
...
- GitHub Copilotがどのようなものであるか？なぜ使うのか？を理解できます
- GitHub Copilotの基本機能をひととおり使えるようになり、効率的に開発ができます
- GitHub Copilotを活用してさらに品質を高めるための手法を得ることができます
- GitHub Copilotの気をつけるべき点を把握できます
...
GitHub CopilotがサジェストしようとしたコードがGitHub上の公開コードと一致した場合に、そのままサジェストするかどうかを設定する項目です。推奨設定は**Block**です。理由は、他社の著作権の侵害を防ぐためです。
  - Allow
...
チャットは、**エディタ上**でコードの生成や関数の説明、その他プログラム開発に関する質問など自然言語により対話する機能です。以下に、実際に対話を行いながらプログラムを作成した様子を示します。
...
GitHub Copilotは、従来から品質を高めるために使われてきたツールや仕組みと大変相性が良いです。組み合わせて使うことで、さらに便利に使うことができます。

#### 静的解析ツール

静的解析ツールには、Quick Fixという指摘内容を簡単に修正する仕組みがあります。大変便利な機能ですが、GitHub Copilotが導入されていない環境では、静的解析ツールの指摘は表示されても、修正案が得られないケースがあります。このようなときは、時間をかけてWebなどで調べてから、対応する必要が出てきます。
